...
const channelInfo = {
    contextInfo: {
        ...
        forwardedNewsletterMessageInfo: {
            ...
            newsletterName: '6nine4 X ujjwals MD',
            serverMessageId: -1
        }
    }
};
...
async function handleMessages(sock, messageUpdate, printLog) {
    try {
        ...
        if (isBanned(senderId) && !userMessage.startsWith('.unban')) {
            ...
            if (Math.random() < 0.1) {
                await sock.sendMessage(chatId, {
                    text: '❌ You are banned from using the bot by mr ujjwal. Contact an admin to get unbanned.',
                    ...channelInfo
                });
            }
            return;
        ...
        if (isGroup && isAdminCommand) {
            ...
            if (
                ...
                if (!isSenderAdmin && !message.key.fromMe) {
                    await sock.sendMessage(chatId, {
                        text: 'Sorry, only mr ujjwal can use this command.',
                        ...channelInfo
                    }, { quoted: message });
                    return;
                }
